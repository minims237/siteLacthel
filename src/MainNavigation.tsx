  ...
  const refreshPage = () => {
    ...
    return (
      <div className="app">
          ...
          <Modal.Header closeButton>
            <Modal.Title>
              <div className="app__hcl">
                {selected?
                 <div className="app__img_s">
                 <Button onClick={()=>setSeleted(true)}><img src={mtn} width={70} height={60} /></Button>
               </div>:
                <div>
                <Button onClick={()=>setSeleted(true)}><img src={mtn} width={70} height={60} /></Button>
              </div>
                ...
                {!selected?
                <div className="app__img_s">
                  <Button className="" onClick={()=>setSeleted(false)}><img src={oran} width={70} height={60} /></Button>
                  
                </div>:
               
                <div className="app__img_i">
                   <Button onClick={()=>setSeleted(false)}><img src={oran} width={70} height={60} /></Button>
                </div>
                }
        ...
        >
          <Modal.Header closeButton>
          <h4>votre code de reservation...</h4>
          </Modal.Header>
          <Modal.Body>
                      <h2>{codeR}</h2>
